...
pl3 <- ggplot(data = df_present, aes(x = year, y = girls)) +
  geom_point(shape = 2, color = 'red') + theme_classic() + ggtitle("Number of girls born during 1940-2002 \n in the US") + 
  theme(plot.title = element_text(hjust = 0.5), aspect.ratio = 0.5) + labs(x = "Year", y = "Number of births")
pl4 <- ggplot(data = df_arb, aes(x = year, y = girls)) +
  geom_point(shape = 2, color = 'blue') + theme_classic() + ggtitle("Number of girls born during 1629-1710 \n in the US") + 
  theme(plot.title = element_text(hjust = 0.5), aspect.ratio = 0.5) + labs(x = "Year", y = "Number of births")
